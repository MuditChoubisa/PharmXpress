    ...
    <div class="container-fluid text-center  text-white" style="background-color: #0d8592;">
        ...
        <div class=" row">
            ...
            <div class="col-sm-4">
                ...
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#" style="color: white; margin-right :20px;"> <i class="fab fa-facebook fa-3x">&nbsp;</i></a>
                <a href="#" style="color: white; margin-right :20px;"><i class="fab fa-instagram fa-3x">&nbsp;</i></a>
                <a href="#" style="color: white; margin-right :20px;"><i class="fab fa-twitter fa-3x"></i></a>
            </div>
        </div>
        <br><br>
        <div class="row">
...
<!-- Copyright -->
<div class="footer-copyright text-center py-3 " style="background-color:#086a76;">© 2023 Copyright:
    <a href="#" target="_blank" style="color: white; text-decoration: none;">PharmXpress.in</a>
</div>
